...
parser.add_argument('--labeled_sample_list', default=None, help='Labeled sample list from a certain percentage of training [static]')
parser.add_argument('--checkpoint_path', default=None, help='Model checkpoint path [default: None]')
parser.add_argument('--dump_dir', default='dump_scannet/sess/', help='Dump dir to save sample outputs [default: None]')
parser.add_argument('--num_point', type=int, default=40000, help='Point Number [default: 40000]')
parser.add_argument('--num_target', type=int, default=128, help='Point Number [default: 128]')
parser.add_argument('--batch_size', type=int, default=8, help='Batch Size during training [default: 8]')
parser.add_argument('--vote_factor', type=int, default=1, help='Number of votes generated from each seed [default: 1]')
parser.add_argument('--cluster_sampling', default='seed_fps', help='Sampling strategy for vote clusters: vote_fps, seed_fps, random [default: vote_fps]')
...
parser.add_argument('--transductive', action='store_true', help='Evaluate transductive learning')
parser.add_argument('--dump_files', action='store_true', help='If save files')
...
if FLAGS.dataset == 'sunrgbd':
    ...
    TEST_DATASET = SunrgbdDetectionVotesDataset(split_set, num_points=NUM_POINT, augment=False,
...
net = votenet.VoteNet(num_class=DATASET_CONFIG.num_class,
